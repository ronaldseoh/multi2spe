...
if __name__ == '__main__':
    ...
    dataset = utils.SciNclTripleDataset(
        triples_csv_path="~/my_696ds-s21/scincl_dataset_wol/train_triples.csv", metadata_jsonl_path="/home/bseoh/my_696ds-s21/scincl_dataset_wol/train_metadata.jsonl",
