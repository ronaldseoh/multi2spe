...
if __name__ == "__main__":
    ...
    cross_domain_metadata_mag = json.load(open("20220721_shard_3_cross/mag_fields_by_paper_ids.json", "r"))["train"]
    ...
    with open("20220721_shard_3_cross/shard11_embeddings.jsonl", "r") as cross_domain_embedding_file:
        while True:
            try:
    ...
    with open("quartermaster/save_shard11_U_k-3_sum_embs_original-0-9+no_sum-0-1_extra_facet_alternate_layer_8_4-alternate_identity_common_random_cross_entropy_05-04/cls.jsonl", "r") as mag_embeddings_file:
