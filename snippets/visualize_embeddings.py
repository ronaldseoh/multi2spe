...
if __name__ == "__main__":
    ...
    with open("quartermaster/save_shard11_k-3_debug_sum_embs_original-0-9+no_sum-0-1+mean-avg_word-0-05_extra_facet_alternate_layer_8_4-alternate_identity_common_random_instance_weights-v5_cross_entropy_03-30/cls_no_sum.jsonl", "r") as mag_embeddings_file:
