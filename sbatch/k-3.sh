#!/bin/bash
#SBATCH --job-name=k-3
#SBATCH -o sbatch_logs/stdout/k-3_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_%j.err
#SBATCH --ntasks=1
...
python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                ...
                --model_behavior 'quartermaster' --num_facets 3 --add_extra_facet_layers --loss_reduction_multifacet 'min' \
