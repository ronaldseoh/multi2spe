#!/bin/bash
#SBATCH --job-name=shard11_debug_specter
#SBATCH -o sbatch_logs/stdout/shard11_debug_specter_%j.txt
#SBATCH -e sbatch_logs/stderr/shard11_debug_specter_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=shard11_debug_specter
