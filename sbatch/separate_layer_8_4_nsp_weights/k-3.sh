#!/bin/bash
#SBATCH --job-name=k-3_separate_layer_8_4_nsp_weights
#SBATCH -o sbatch_logs/stdout/k-3_separate_layer_8_4_nsp_weights_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_separate_layer_8_4_nsp_weights_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-3_separate_layer_8_4_nsp_weights
