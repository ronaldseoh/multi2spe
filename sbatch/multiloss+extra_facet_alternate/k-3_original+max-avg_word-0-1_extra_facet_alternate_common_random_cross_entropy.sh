#!/bin/bash
#SBATCH --job-name=k-3_original+max-avg_word-0-1_extra_facet_alternate_common_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/k-3_original+max-avg_word-0-1_extra_facet_alternate_common_random_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_original+max-avg_word-0-1_extra_facet_alternate_common_random_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-3_original+max-avg_word-0-1_extra_facet_alternate_common_random_cross_entropy
