#!/bin/bash
#SBATCH --job-name=k-5_original_margin_loss_extra_facet_alternate_common_random_init_cross_entropy
#SBATCH -o sbatch_logs/stdout/k-5_original_margin_loss_extra_facet_alternate_common_random_init_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/k-5_original_margin_loss_extra_facet_alternate_common_random_init_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-5_original_margin_loss_extra_facet_alternate_common_random_init_cross_entropy
...
python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                ...
                --loss_config '[{"name": "original", "weight": 1, "loss_type": "margin", "margin": 1.0, "distance": "l2-norm", "reduction": "mean", "reduction_multifacet": "min", "use_target_token_embs": false}]' \
