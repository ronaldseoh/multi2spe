...
python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                ...
                --train_weights_file ~/my_scratch/20220328_shard_11_10_9/preprocessed/train_weights.json \
                --val_weights_file ~/my_scratch/20220328_shard_11_10_9/preprocessed/val_weights.json \
