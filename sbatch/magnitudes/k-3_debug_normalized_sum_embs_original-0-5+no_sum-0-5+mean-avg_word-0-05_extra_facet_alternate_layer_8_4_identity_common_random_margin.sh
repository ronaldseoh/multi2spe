#!/bin/bash
#SBATCH --job-name=k-3_debug_normalized_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_margin
#SBATCH -o sbatch_logs/stdout/k-3_debug_normalized_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_margin_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_debug_normalized_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_margin_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-3_debug_normalized_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_margin
