#!/bin/bash
#SBATCH --job-name=k-3_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_common_random_cross_entropy
...
EXPERIMENT_ID_PREFIX=k-3_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_common_random_cross_entropy
