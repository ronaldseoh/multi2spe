#!/bin/bash
#SBATCH --job-name=k-3_sum_embs_original-0-9+no_sum-0-1+max-individual_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_cross_entropy
...
EXPERIMENT_ID_PREFIX=k-3_sum_embs_original-0-9+no_sum-0-1+max-individual_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_cross_entropy
