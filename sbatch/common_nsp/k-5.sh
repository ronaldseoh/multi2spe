#!/bin/bash
#SBATCH --job-name=k-5_common_nsp
#SBATCH -o sbatch_logs/stdout/k-5_common_nsp_%j.txt
#SBATCH -e sbatch_logs/stderr/k-5_common_nsp_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-5_common_nsp
