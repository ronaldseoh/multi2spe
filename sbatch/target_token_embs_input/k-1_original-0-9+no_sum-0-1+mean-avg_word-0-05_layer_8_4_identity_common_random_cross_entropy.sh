#!/bin/bash
#SBATCH --job-name=k-1_original-0-9+no_sum-0-1+mean-avg_word-0-05-input_emb_layer_8_4_identity_common_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/k-1_original-0-9+no_sum-0-1+mean-avg_word-0-05-input_emb_layer_8_4_identity_common_random_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/k-1_original-0-9+no_sum-0-1+mean-avg_word-0-05-input_emb_layer_8_4_identity_common_random_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-1_original-0-9+no_sum-0-1+mean-avg_word-0-05-input_emb_layer_8_4_identity_common_random_cross_entropy
