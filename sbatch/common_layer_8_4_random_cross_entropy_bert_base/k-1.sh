#!/bin/bash
#SBATCH --job-name=k-1_common_layer_8_4_random_cross_entropy_bert_base
#SBATCH -o sbatch_logs/stdout/k-1_common_layer_8_4_random_cross_entropy_bert_base_%j.txt
#SBATCH -e sbatch_logs/stderr/k-1_common_layer_8_4_random_cross_entropy_bert_base_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-1_common_layer_8_4_random_cross_entropy_bert_base
