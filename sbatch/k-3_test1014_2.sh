#!/bin/bash
#SBATCH --job-name=k-3_test1014_2_common_cross_entropy_specter_mean_emb
#SBATCH -o sbatch_logs/stdout/k-3_test1014_2_common_cross_entropy_specter_mean_emb_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_test1014_2_common_cross_entropy_specter_mean_emb_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-3_test1014_2_common_cross_entropy_specter_mean_emb
