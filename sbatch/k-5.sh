#!/bin/bash
#SBATCH --job-name=k-5
#SBATCH -o sbatch_logs/stdout/k-5_%j.txt
#SBATCH -e sbatch_logs/stderr/k-5_%j.err
#SBATCH --ntasks=1
...
python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                ...
                --model_behavior 'quartermaster' --num_facets 5 --add_extra_facet_layers --loss_reduction_multifacet 'min' \
