...
#SBATCH --job-name=shard22_33_44_medicine_debug_specter
#SBATCH -o sbatch_logs/stdout/shard22_33_44_medicine_debug_specter_%j.txt
#SBATCH -e sbatch_logs/stderr/shard22_33_44_medicine_debug_specter_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=shard22_33_44_medicine_debug_specter
