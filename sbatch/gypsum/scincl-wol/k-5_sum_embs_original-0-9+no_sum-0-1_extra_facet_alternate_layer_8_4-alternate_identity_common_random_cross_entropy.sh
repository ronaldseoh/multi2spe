...
python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                --train_file ~/my_scratch/scincl_dataset_wol/train_triples.csv --train_metadata_file ~/my_696ds-s21/scincl_dataset_wol/train_metadata.jsonl --train_file_from_scincl --train_size 684100 \
