...
#SBATCH --job-name=shard11_k-1_debug_original-0-9+no_sum-0-1_layer_8_4_identity_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/shard11_k-1_debug_original-0-9+no_sum-0-1_layer_8_4_identity_random_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/shard11_k-1_debug_original-0-9+no_sum-0-1_layer_8_4_identity_random_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=shard11_k-1_debug_original-0-9+no_sum-0-1_layer_8_4_identity_random_cross_entropy
