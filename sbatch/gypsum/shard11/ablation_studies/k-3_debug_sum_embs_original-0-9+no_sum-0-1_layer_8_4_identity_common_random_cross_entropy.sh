#!/bin/bash
#SBATCH --job-name=shard11_k-3_debug_sum_embs_original-0-9+no_sum-0-1_layer_8_4_identity_common_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/shard11_k-3_debug_sum_embs_original-0-9+no_sum-0-1_layer_8_4_identity_common_random_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/shard11_k-3_debug_sum_embs_original-0-9+no_sum-0-1_layer_8_4_identity_common_random_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=shard11_k-3_debug_sum_embs_original-0-9+no_sum-0-1_original-0-9+no_sum-0-1_layer_8_4_identity_common_random_cross_entropy
