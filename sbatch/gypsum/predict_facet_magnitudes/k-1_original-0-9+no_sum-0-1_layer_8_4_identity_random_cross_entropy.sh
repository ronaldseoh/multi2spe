...
#SBATCH --job-name=facet_mag_k-1_original-0-9+no_sum-0-1_layer_8_4_identity_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/facet_mag_k-1_original-0-9+no_sum-0-1_layer_8_4_identity_random_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/facet_mag_k-1_original-0-9+no_sum-0-1_layer_8_4_identity_random_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=facet_mag_k-1_original-0-9+no_sum-0-1_layer_8_4_identity_random_cross_entropy
