#!/bin/bash
#SBATCH --job-name=scincl-wol-readme_specter
#SBATCH -o sbatch_logs/stdout/scincl-wol-readme_specter_%j.txt
#SBATCH -e sbatch_logs/stderr/scincl-wol-readme_specter_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=scincl-wol-readme_specter
