#!/bin/bash
#SBATCH --job-name=U_k-3_normalized_magnitudes_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_margin
#SBATCH -o sbatch_logs/stdout/U_k-3_normalized_magnitudes_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_margin_%j.txt
#SBATCH -e sbatch_logs/stderr/U_k-3_normalized_magnitudes_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_margin_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=U_k-3_normalized_magnitudes_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_margin
