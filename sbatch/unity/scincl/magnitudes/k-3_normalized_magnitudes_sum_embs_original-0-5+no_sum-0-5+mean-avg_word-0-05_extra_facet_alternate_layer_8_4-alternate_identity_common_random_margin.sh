#!/bin/bash
#SBATCH --job-name=scincl_U_k-3_normalized_magnitudes_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4-alternate_identity_common_random_margin
#SBATCH -o sbatch_logs/stdout/scincl_U_k-3_normalized_magnitudes_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4-alternate_identity_common_random_margin_%j.txt
#SBATCH -e sbatch_logs/stderr/scincl_U_k-3_normalized_magnitudes_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4-alternate_identity_common_random_margin_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=scincl_U_k-3_normalized_magnitudes_sum_embs_original-0-5+no_sum-0-5+mean-avg_word-0-05_extra_facet_alternate_layer_8_4-alternate_identity_common_random_margin
EXPERIMENT_DATE=`date +"%m-%d"`

python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                --train_file /gypsum/scratch1/bseoh/scincl_dataset/train_triples.csv --train_metadata_file /gypsum/scratch1/bseoh/scincl_dataset/train_metadata.jsonl --train_file_from_scincl --train_size 684100 \
                ...
                --loss_config '[{"name": "original", "weight": 0.5, "loss_type": "margin", "margin": 1.0, "distance": "l2-norm", "reduction": "mean", "reduction_multifacet": "min", "use_target_token_embs": false, "sum_into_single_embeddings": true, "predict_facet_magnitudes": true}, {"name": "no_sum", "weight": 0.5, "loss_type": "margin", "margin": 1.0, "distance": "l2-norm", "reduction": "mean", "reduction_multifacet": "min", "use_target_token_embs": false, "sum_into_single_embeddings": false, "predict_facet_magnitudes": true}, {"name": "mean_and_word_emb", "weight": 0.05, "loss_type": "margin", "margin": 1.0, "distance": "l2-norm", "reduction": "mean", "reduction_multifacet": "mean", "use_target_token_embs": true}]' \
...
python embed.py --pl-checkpoint-path save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/checkpoints/last.ckpt \
                --debug_disable_multiply_facet_magnitudes \
                --data-path ../scidocs/data/paper_metadata_mag_mesh.json \
                --output save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/cls_no_multiply_magnitudes.jsonl --batch-size 4
                
python embed.py --pl-checkpoint-path save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/checkpoints/last.ckpt \
                --debug_disable_multiply_facet_magnitudes \
                --data-path ../scidocs/data/paper_metadata_recomm.json \
                --output save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/recomm_no_multiply_magnitudes.jsonl --batch-size 4
                
python embed.py --pl-checkpoint-path save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/checkpoints/last.ckpt \
                --debug_disable_multiply_facet_magnitudes \
                --data-path ../scidocs/data/paper_metadata_view_cite_read.json \
                --output save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/user-citation_no_multiply_magnitudes.jsonl --batch-size 4
