#!/bin/bash
#SBATCH --job-name=scincl_U_debug_specter
#SBATCH -o sbatch_logs/stdout/scincl_U_debug_specter_%j.txt
#SBATCH -e sbatch_logs/stderr/scincl_U_debug_specter_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=scincl_U_debug_specter
