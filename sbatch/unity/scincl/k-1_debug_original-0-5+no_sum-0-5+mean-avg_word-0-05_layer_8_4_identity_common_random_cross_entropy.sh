#!/bin/bash
#SBATCH --job-name=scincl_U_k-1_debug_original-0-5+no_sum-0-5+mean-avg_word-0-05_layer_8_4_identity_common_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/scincl_U_k-1_debug_original-0-5+no_sum-0-5+mean-avg_word-0-05_layer_8_4_identity_common_random_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/scincl_U_k-1_debug_original-0-5+no_sum-0-5+mean-avg_word-0-05_layer_8_4_identity_common_random_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=scincl_U_k-1_debug_original-0-5+no_sum-0-5+mean-avg_word-0-05_layer_8_4_identity_common_random_cross_entropy
