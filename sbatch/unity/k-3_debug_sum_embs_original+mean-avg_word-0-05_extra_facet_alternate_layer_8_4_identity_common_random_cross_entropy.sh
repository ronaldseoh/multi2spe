#!/bin/bash
#SBATCH --job-name=U_k-3_debug_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/U_k-3_debug_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/U_k-3_debug_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=U_k-3_debug_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_common_random_cross_entropy
