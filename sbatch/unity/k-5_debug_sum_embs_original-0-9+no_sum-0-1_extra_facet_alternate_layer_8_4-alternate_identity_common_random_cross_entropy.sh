#!/bin/bash
#SBATCH --qos=gypsum-ms-titanx
#SBATCH --job-name=U_k-5_debug_sum_embs_original-0-9+no_sum-0-1_extra_facet_alternate_layer_8_4-alternate_identity_common_random_cross_entropy
