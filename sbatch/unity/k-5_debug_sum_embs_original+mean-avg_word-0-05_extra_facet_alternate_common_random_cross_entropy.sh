#!/bin/bash
#SBATCH --job-name=U_k-5_debug_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_common_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/U_k-5_debug_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_common_random_cross_entropy_%j.txt
