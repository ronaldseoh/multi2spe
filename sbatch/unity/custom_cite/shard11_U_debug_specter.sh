#!/bin/bash
#SBATCH --job-name=custom_cite_shard11_U_debug_specter
#SBATCH -o sbatch_logs/stdout/custom_cite_shard11_U_debug_specter_%j.txt
#SBATCH -e sbatch_logs/stderr/custom_cite_shard11_U_debug_specter_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=shard11_U_debug_specter
