#!/bin/bash
#SBATCH --job-name=shard11_U_debug_specter
#SBATCH -o sbatch_logs/stdout/shard11_U_debug_specter_%j.txt
#SBATCH -e sbatch_logs/stderr/shard11_U_debug_specter_%j.err
#SBATCH --ntasks=1
