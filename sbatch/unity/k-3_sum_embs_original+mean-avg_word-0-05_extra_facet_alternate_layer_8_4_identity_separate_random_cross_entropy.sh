#!/bin/bash
#SBATCH --job-name=k-3_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_separate_random_cross_entropy
#SBATCH -o sbatch_logs/stdout/k-3_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_separate_random_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_sum_embs_original+mean-avg_word-0-05_extra_facet_alternate_layer_8_4_identity_separate_random_cross_entropy_%j.err
#SBATCH --ntasks=1
...
python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                ...
                --add_extra_facet_layers_for_target \
