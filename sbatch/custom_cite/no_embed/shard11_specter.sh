#!/bin/bash
#SBATCH --job-name=custom_cite_shard11_specter
#SBATCH -o sbatch_logs/stdout/custom_cite_shard11_specter_%j.txt
#SBATCH -e sbatch_logs/stderr/custom_cite_shard11_specter_%j.err
#SBATCH --ntasks=1
...
python ../scidocs/scripts/run_custom_cite.py --user-citation ../quartermaster/save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/user-citation_custom_cite.jsonl \
                      ...
                      --results-save-path save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/results_custom_cite_pos5.xlsx
