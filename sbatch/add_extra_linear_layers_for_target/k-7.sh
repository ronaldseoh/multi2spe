#!/bin/bash
#SBATCH --job-name=k-7_add_extra_linear_layers_for_target
#SBATCH -o sbatch_logs/stdout/k-7_add_extra_linear_layers_for_target_%j.txt
#SBATCH -e sbatch_logs/stderr/k-7_add_extra_linear_layers_for_target_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-7_add_extra_linear_layers_for_target
