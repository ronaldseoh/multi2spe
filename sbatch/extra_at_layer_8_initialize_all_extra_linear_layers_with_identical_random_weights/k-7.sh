#!/bin/bash
#SBATCH --job-name=k-7_extra_at_layer_8_initialize_all_extra_linear_layers_with_identical_random_weights
#SBATCH -o sbatch_logs/stdout/k-7_extra_at_layer_8_initialize_all_extra_linear_layers_with_identical_random_weights_%j.txt
#SBATCH -e sbatch_logs/stderr/k-7_extra_at_layer_8_initialize_all_extra_linear_layers_with_identical_random_weights_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-7_extra_at_layer_8_initialize_all_extra_linear_layers_with_identical_random_weights
