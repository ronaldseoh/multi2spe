#!/bin/bash
#SBATCH --job-name=k-7
#SBATCH -o sbatch_logs/stdout/k-7_%j.txt
#SBATCH -e sbatch_logs/stderr/k-7_%j.err
#SBATCH --ntasks=1
...
python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                ...
                --model_behavior 'quartermaster' --num_facets 7 --add_extra_facet_layers --loss_reduction_multifacet 'min' \
