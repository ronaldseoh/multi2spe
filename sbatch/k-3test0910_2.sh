...
#SBATCH -o sbatch_logs/stdout/k-3_no_separate_8_random_weights_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_no_separate_8_random_weights_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-3_no_separate_8_random_weights
