#!/bin/bash
#SBATCH --job-name=k-3_common_nsp_cross_entropy_specter
#SBATCH -o sbatch_logs/stdout/k-3_common_nsp_cross_entropy_specter_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_common_nsp_cross_entropy_specter_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-3_common_nsp_cross_entropy_specter
