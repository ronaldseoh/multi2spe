#!/bin/bash
#SBATCH --job-name=scidocs_only_normalize
#SBATCH -o sbatch_logs/stdout/scidocs_only_normalize_%j.txt
#SBATCH -e sbatch_logs/stderr/scidocs_only_normalize_%j.err
#SBATCH --ntasks=1
