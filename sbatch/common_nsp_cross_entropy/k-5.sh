#!/bin/bash
#SBATCH --job-name=k-5_common_nsp_cross_entropy
#SBATCH -o sbatch_logs/stdout/k-5_common_nsp_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/k-5_common_nsp_cross_entropy_%j.err
#SBATCH --ntasks=1
...
python ../scidocs/scripts/run.py --cls save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/cls.jsonl \
                      ...
                      --data-path ../scidocs/data \
                      --results-save-path save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE}/results_normalize.xlsx
