#!/bin/bash
#SBATCH --job-name=k-1_multiloss_test_common_nsp_cross_entropy
#SBATCH -o sbatch_logs/stdout/k-1_multiloss_test_common_nsp_cross_entropy_%j.txt
#SBATCH -e sbatch_logs/stderr/k-1_multiloss_test_common_nsp_cross_entropy_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-1_multiloss_test_common_nsp_cross_entropy
