#!/bin/bash
#SBATCH --job-name=k-3_mean-mean_and_More_mean-word_emb
#SBATCH -o sbatch_logs/stdout/k-3_mean-mean_and_More_mean-word_emb_%j.txt
#SBATCH -e sbatch_logs/stderr/k-3_mean-mean_and_More_mean-word_emb_%j.err
#SBATCH --ntasks=1
...
EXPERIMENT_ID_PREFIX=k-3_mean-mean_and_More_mean-word_emb
...
python train.py --save_dir save_${EXPERIMENT_ID_PREFIX}_${EXPERIMENT_DATE} \
                ...
                --loss_config '[{"name": "mean_and_word_emb", "weight": 20, "loss_type": "bce", "margin": 1.0, "distance": "dot", "reduction": "mean", "reduction_multifacet": "mean", "use_target_token_embs": true}, {"name": "mean_and_mean", "weight": 1, "loss_type": "bce", "margin": 1.0, "distance": "dot", "reduction": "mean", "reduction_multifacet": "mean", "use_target_token_embs": false}]' \
